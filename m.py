...
bot = telebot.TeleBot('7955245382:AAHS62duTTlDYlcIzIQ7AuwlDpj4rMt1rmE')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi @RitikXyz099")
...
Official Channel :- https://t.me/+uToh9lMXXn81ZDJl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+uToh9lMXXn81ZDJl OTHERWISE NOT WORK
